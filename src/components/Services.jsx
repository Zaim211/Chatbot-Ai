  ...
  return (
    <Section id="Comment-fonctionne">
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex flex-col lg:flex-row items-center lg:h-[46rem] mb-5 p-6 lg:p-20 border border-n-1/10 rounded-3xl overflow-hidden gap-8">
            {/* Image on the left */}
            <div className="relative z-1 w-full lg:w-1/2">
              <img
                src={service2}
                className="h-[200px] sm:h-[300px] lg:h-full w-full object-cover rounded-md"
                width={630}
                height={750}
                alt="Chatbot intégré"
              />
            ...
            {/* Explanation about how the chatbot works on the right */}
            <div className="relative z-1 w-full lg:w-1/2">
              <h4 className="h4 mb-4 mt-2 text-center lg:text-left">
                Comment fonctionne notre Chatbot ?
              </h4>

              <div className="mb-6 text-n-3">
                <p className="flex sm:flex-row items-start  mb-6">
                  <span className="w-24 h-8  flex items-center justify-center rounded-full bg-purple-700 text-white mr-4">
                    1
                  </span>
                  Notre chatbot utilise des scénarios préconfigurés pour
                  interagir avec vos visiteurs en temps réel. Il est conçu pour
                ...
                <p className="flex sm:flex-row items-start ">
                  <span className="w-20 lg:w-20 h-8 flex items-center justify-center rounded-full bg-purple-700 text-white mr-4">
                    3
                  </span>
                  Notre chatbot peut aussi prendre en charge la génération de
                  prospects, en recueillant les informations clés et en les
